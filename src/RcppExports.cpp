...
// cLogLikelihood
double cLogLikelihood(const NumericVector& Yvec, const NumericVector& Xvec, const IntegerVector& DIMS, const NumericVector& ALPHA, const NumericVector& SS);
RcppExport SEXP dnc_cLogLikelihood(SEXP YvecSEXP, SEXP XvecSEXP, SEXP DIMSSEXP, SEXP ALPHASEXP, SEXP SSSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    ...
    Rcpp::traits::input_parameter< const NumericVector& >::type SS(SSSEXP);
    __result = Rcpp::wrap(cLogLikelihood(Yvec, Xvec, DIMS, ALPHA, SS));
    return __result;
END_RCPP
}
// cposteriorNoOmega
double cposteriorNoOmega(const IntegerVector& dims, const NumericVector& Yvec, const NumericVector& XVec, const NumericVector& RR, const NumericVector& TAU, const NumericVector& SS, const NumericVector& ALPHA, const NumericMatrix& BETA, const IntegerMatrix& Z, const NumericMatrix& UU, const NumericVector& CC, const NumericMatrix& GAMSTAR, const NumericVector& A2STAR, const NumericVector& B2STAR, const NumericVector& B3STAR);
RcppExport SEXP dnc_cposteriorNoOmega(SEXP dimsSEXP, SEXP YvecSEXP, SEXP XVecSEXP, SEXP RRSEXP, SEXP TAUSEXP, SEXP SSSEXP, SEXP ALPHASEXP, SEXP BETASEXP, SEXP ZSEXP, SEXP UUSEXP, SEXP CCSEXP, SEXP GAMSTARSEXP, SEXP A2STARSEXP, SEXP B2STARSEXP, SEXP B3STARSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< const IntegerVector& >::type dims(dimsSEXP);
    ...
    __result = Rcpp::wrap(cposteriorNoOmega(dims, Yvec, XVec, RR, TAU, SS, ALPHA, BETA, Z, UU, CC, GAMSTAR, A2STAR, B2STAR, B3STAR));
    return __result;
END_RCPP
}
// csimulateData
arma::cube csimulateData(const NumericVector& Xvec, const IntegerVector& dims, const NumericVector& ALPHA, const NumericVector& SS);
RcppExport SEXP dnc_csimulateData(SEXP XvecSEXP, SEXP dimsSEXP, SEXP ALPHASEXP, SEXP SSSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< const NumericVector& >::type Xvec(XvecSEXP);
    ...
    Rcpp::traits::input_parameter< const NumericVector& >::type ALPHA(ALPHASEXP);
    Rcpp::traits::input_parameter< const NumericVector& >::type SS(SSSEXP);
    __result = Rcpp::wrap(csimulateData(Xvec, dims, ALPHA, SS));
    return __result;
END_RCPP
}
// cVBnoClust
Rcpp::List cVBnoClust(const IntegerVector& dims, const NumericVector& Yvec, const NumericVector& muVec, const NumericVector& SigVec, const NumericVector& A2STAR, const NumericVector& B2STAR, const NumericVector& B3STAR, const NumericVector& EOmVec, const NumericVector& A0, const NumericVector& B0, const NumericVector& A0STAR, const NumericVector& B0STAR, const NumericVector& AI2, const NumericVector& BI2, const NumericVector& A3, const NumericVector& B3, const NumericVector& ES, const NumericVector& ES2);
RcppExport SEXP dnc_cVBnoClust(SEXP dimsSEXP, SEXP YvecSEXP, SEXP muVecSEXP, SEXP SigVecSEXP, SEXP A2STARSEXP, SEXP B2STARSEXP, SEXP B3STARSEXP, SEXP EOmVecSEXP, SEXP A0SEXP, SEXP B0SEXP, SEXP A0STARSEXP, SEXP B0STARSEXP, SEXP AI2SEXP, SEXP BI2SEXP, SEXP A3SEXP, SEXP B3SEXP, SEXP ESSEXP, SEXP ES2SEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< const IntegerVector& >::type dims(dimsSEXP);
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(cVBUpdate(DIMS, Yvec, CC, GAMSTAR, A2STAR, B2STAR, B3STAR, EOmVec, muVec, SigVec, BI0G, BitbarVec, BithkVec, ER, ER2, AI2, BI2, NU, A3, B3, ES, ES2, GAM));
    return __result;
END_RCPP
}
// drawMiss
Rcpp::List drawMiss(const IntegerVector& dims, const NumericVector& Yvec, const NumericVector& SS, const IntegerMatrix& MISS, const NumericVector& XVec, const NumericVector& ALPHA);
RcppExport SEXP dnc_drawMiss(SEXP dimsSEXP, SEXP YvecSEXP, SEXP SSSEXP, SEXP MISSSEXP, SEXP XVecSEXP, SEXP ALPHASEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< const IntegerVector& >::type dims(dimsSEXP);
    ...
    Rcpp::traits::input_parameter< const NumericVector& >::type XVec(XVecSEXP);
    Rcpp::traits::input_parameter< const NumericVector& >::type ALPHA(ALPHASEXP);
    __result = Rcpp::wrap(drawMiss(dims, Yvec, SS, MISS, XVec, ALPHA));
    return __result;
END_RCPP
}
// drawS
...
// drawXZar
Rcpp::List drawXZar(const IntegerVector& dims, const NumericVector& XVec, const NumericVector& Yvec, const NumericVector& OmVec, const NumericVector& SS, const NumericVector& ALPHA, const NumericVector& TAU, const NumericVector& RR, const NumericMatrix& UU, const IntegerMatrix& ZZ, const NumericVector& rnVec, const NumericMatrix& BB, const NumericVector& RNa, const NumericVector& B3Star, const NumericVector& CC);
RcppExport SEXP dnc_drawXZar(SEXP dimsSEXP, SEXP XVecSEXP, SEXP YvecSEXP, SEXP OmVecSEXP, SEXP SSSEXP, SEXP ALPHASEXP, SEXP TAUSEXP, SEXP RRSEXP, SEXP UUSEXP, SEXP ZZSEXP, SEXP rnVecSEXP, SEXP BBSEXP, SEXP RNaSEXP, SEXP B3StarSEXP, SEXP CCSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< const IntegerVector& >::type dims(dimsSEXP);
    ...
    Rcpp::traits::input_parameter< const NumericVector& >::type B3Star(B3StarSEXP);
    Rcpp::traits::input_parameter< const NumericVector& >::type CC(CCSEXP);
    __result = Rcpp::wrap(drawXZar(dims, XVec, Yvec, OmVec, SS, ALPHA, TAU, RR, UU, ZZ, rnVec, BB, RNa, B3Star, CC));
    return __result;
END_RCPP
}
